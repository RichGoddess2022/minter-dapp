const abi = [const contractAddress = "0x936447B2ee4225e146fe8129EC72F6dE24cf12b1"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to Rich Goddess Paradise.";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Rich Goddess Paradise is a collection of 111 AI-generated goddesses radiating their love and light on the Ethereum Blockchain.';
